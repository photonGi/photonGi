# 💫 About Me:
🎨 Frontend Developer passionate about exploring market trends and evolving with new technologies.<br>🚀 Transitioned to mastering the MERN Stack to build dynamic, full-stack web applications.<br>🌱 Currently honing my skills in React-Redux Toolkit and scalable architecture design.<br>🔧 Experienced with projects like Namal College and AGACrane (construction equipment rentals).<br>💼 Proficient in React, CodeIgniter, and Shopify, with a focus on creating seamless user experiences.<br>🌟 A problem-solver at heart, eager to collaborate and contribute to impactful projects.
...
---
[![](https://visitcount.itsvg.in/api?id=photonGi&icon=5&color=4)](https://visitcount.itsvg.in)
